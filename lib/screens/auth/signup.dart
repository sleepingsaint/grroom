...
class _SignupScreenState extends State<SignupScreen> {
  ...
  final String _signupEndpoint = "https://groombackend.herokuapp.com/api/v1/user/signup";
      ...
      if(decodedRes["status"] == "success"){
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => Scaffold(
              body: AuthSuccess("Account created successfully", secondaryMessage: "Please Wait for admin approval :)",),
            ))
          );
      }
      else{
            ...
            children: [
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  validator: (val) => val.isEmpty || !EmailValidator.validate(_emailController.text) ? "Please fill this field with valid email" : null,
                ),
              ),
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: TextFormField(
                  ...
                  validator: (val) => (val.isEmpty || val.length < 8) ? "Please fill this field with min 8 characters" : null,
                ),
              ),
              Padding(
                padding: const EdgeInsets.all(8.0),
